...
public class Q2_Selenium {
 ...
 13- En son adim olarak butun sayfalarimizi kapatmis olalim
    ...
    public void test01(){
        ...
        Assert.assertTrue(title.contains(ExpectedIcerik));
        Assert.assertFalse(url.contains(ExpectedIcerik));
    }
    ...
    public void test02(){
        ...
        String expectedTitleIcerik = "Quarter";

        Assert.assertTrue(wiseTitle.contains(expectedTitleIcerik));
