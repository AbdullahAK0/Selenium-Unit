...
public class C02_SwitchToIFrame extends TestBase {
    ...
    public void test01(){
        ...
        /*
            ...
            isimiz bittiginde veya baska bir frame'e gecmek istedigimizde
            once calismak istedigimiz yere gecis yapmaliyiz.
         */

        driver.switchTo().parentFrame(); // ic ice frame'lerde bir ust seviyeye cikar
